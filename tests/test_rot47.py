...
class TestRot47:
    ...
    def test_should_return_encrypted_message_for_string_without_spaces_or_special_characters(self):
        ...
        assert Rot47.encode(self.base) == "5@8"
    ...
    def test_should_return_encrypted_message_for_string_with_spaces(self):
        ...
        assert Rot47.encode(self.base) == "w6 564:565 E@ 72<6 9:D 5:D2AA62C2?46 E@ 2G@:5 ;2:="
    ...
    def test_should_return_encrypted_message_for_string_with_punctuation(self):
        ...
        assert Rot47.encode(self.base) == "r9@@D:?8 E@ 5@ ?@E9:?8 :D DE:== 2 49@:46[ 27E6C 2==]"

    def test_should_return_encrypted_message_for_string_with_numbers(self):
        self.base = "My favourite numbers are: 3, 726, 28."

        assert Rot47.encode(self.base) == "|J 72G@FC:E6 ?F>36CD 2C6i b[ fae[ ag]"
